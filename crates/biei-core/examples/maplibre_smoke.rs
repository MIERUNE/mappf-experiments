...
use biei_core::renderer::ProfilePreparer;
use biei_core::renderer::Renderer;
use biei_core::renderer::actor::RendererActorConfig;
use biei_core::renderer::maplibre::{MapLibreProfilePreparer, MapLibreRenderer};
...
impl Args {
    ...
    fn task(&self, style: StyleRevision, output_format: ImageFormat) -> InternalTask {
        ...
        InternalTask {
            id: 1,
            request_id: biei_core::types::RequestId::from_string("maplibre-smoke"),
            style,
            source: None,
