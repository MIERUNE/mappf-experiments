...
use super::peer_snapshot::{Peer, PeerDirectory};
...
mod tests {
    ...
    use super::{
        ...
        PEER_RETRY_BACKOFF, PeerBackend, PeerDirectory, PeerFetchError, ProviderRequest,
        ProviderRouteOutcome, ProviderSpriteVariant, decode_bootstrap_wire, internal_resource_kind,
        internal_response_body_limit,
    };
    use crate::{
        interned::{ResourceRoutingKey, TilesetId},
        metrics::NodeMetrics,
        storage::peer_snapshot::PeerFuture,
