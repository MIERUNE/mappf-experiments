...
pub(crate) struct ProviderHealthTracker {
...
impl ProviderHealthTracker {
    ...
    pub(crate) fn begin_retry(&self) -> ProviderRetryGuard {
    ...
    pub(crate) fn active_retries(&self) -> usize {
    ...
    pub(crate) fn has_slow_attempt(&self) -> bool {
    ...
    pub(crate) fn has_external_evidence(&self) -> bool {
        self.has_active_retry() || self.has_slow_attempt()
    }
}

#[derive(Debug)]
pub(crate) struct ProviderRetryGuard {
