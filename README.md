...
- Extras:
  - **Derived terrain products** - generated on the fly from a raster DEM source like Mapterhorn:
    - Pre-computed hillshade, kept small for cheap serving (~1/10 the source DEM)
